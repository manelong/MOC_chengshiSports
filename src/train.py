...
from MOC_utils.model import create_model, load_model, save_model, load_coco_pretrained_model, load_imagenet_pretrained_model, load_multisports_pretrained_model
...
def main(opt):
    ...
    elif opt.pretrain_model == 'multisports':
        model = load_multisports_pretrained_model(opt, model)
    else:
